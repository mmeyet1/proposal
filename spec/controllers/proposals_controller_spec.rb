  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved proposal as @proposal" do
        ...
        post :create, {:proposal => { "title" => "invalid value" }}, valid_session
        assigns(:proposal).should be_a_new(Proposal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested proposal" do
        ...
        Proposal.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => proposal.to_param, :proposal => { "title" => "MyString" }}, valid_session
      end
